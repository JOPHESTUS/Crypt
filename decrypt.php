...
<head>
	...
	<title>Decryption - JOPHEST.US</title>
...
// Test output 
echo '<h4>Your Encrypted Message:</h4><textarea  name="" id="" cols="50" rows="6" disabled="true">'.$string1.'</textarea>'."\n"; 

echo '<h4><br>Your Decrypted Message:</h4><textarea  name="" id="" cols="50" rows="6" disabled="true">'.$string2.'</textarea>'."\n"; 
